...
<div class="post">
  <header class="post-header">
    <h1 class="post-title">PhD Graduates</h1>
    <h2 class="post-description">PhD graduates from the Spectrum Lab</h2>
  </header>

  <article>
    <div class="people">
      {%- assign categorized_people = site.people | where: "category", "PhD Graduates" -%}
